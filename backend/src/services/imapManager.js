...
import { computeThreadId, parseReferences, normalizeSubject } from './threading.js';
...
// Threading (computeThreadId + its subject/reference helpers) lives in
// ./threading.js so command-line scripts can reuse it without importing this
// module and, through it, the whole server bootstrap. Imported at the top for
// internal use; re-exported here so the existing import surface (and tests)
// keep working.
export { computeThreadId, parseReferences, normalizeSubject };
