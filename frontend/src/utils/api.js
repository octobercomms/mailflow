...
export const api = {
  ...
  findDuplicates: (id) => request('GET', `/accounts/${id}/duplicates`),
  removeDuplicates: (id) => request('POST', `/accounts/${id}/duplicates/remove`),
  ...
  tasksSaveSources: (sources, autoRefresh, autoDrafts, ownerNames) => request('PUT', '/tasks/sources', { sources, autoRefresh, autoDrafts, ownerNames }),
  tasksRefresh: (rebuild) => request('POST', '/tasks/refresh', { rebuild: !!rebuild }),
